...
ui <- {fluidPage (
  titlePanel("Data analysis of La Romaine hydroelectric complex from onset of flooding"),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      helpText("*La Romaine 1 and 3 was flooded only in 2016 and 2017, respectively"),
